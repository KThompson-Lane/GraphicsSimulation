...
void CelestialBody::render(glm::mat4& viewingMatrix, glm::mat4& ProjectionMatrix, bool showCollider, Light& light)
{
	...
	Object::render(viewingMatrix, ProjectionMatrix, showCollider, light);
}
